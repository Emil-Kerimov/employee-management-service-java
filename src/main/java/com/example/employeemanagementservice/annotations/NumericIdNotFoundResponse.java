...
@ApiResponse(responseCode = "404", description = "No resource with this ID was found.",
        content = @Content(
                ...
                examples = @ExampleObject(
                        ...
                        value = "{\"error\": \"Resource with id 1 not found\"}"
                )))
public @interface NumericIdNotFoundResponse {
}